...
public abstract class AbstractPostgreSQLBaseIT extends AbstractBaseIT {
    ...
    private static final DaprContainer DAPR_CONTAINER = new DaprContainer("daprio/daprd:1.13.2")
            ...
            .withNetwork(DAPR_NETWORK)
            .withComponent(new DaprContainer.Component(STATE_STORE_NAME, "state.postgresql", STATE_STORE_PROPERTIES))
            .withComponent(new DaprContainer.Component(BINDING_NAME, "bindings.postgresql", BINDING_PROPERTIES))
