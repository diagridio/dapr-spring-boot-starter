...
public abstract class BaseIntegrationTest {
    ...
    public static final DaprContainer daprContainer = new DaprContainer("daprio/daprd:1.13.2")
            ...
            .withNetwork(daprNetwork)
            .withComponent(new DaprContainer.Component("kvstore", "state.postgresql", getStateStoreProperties()))
            .withComponent(new DaprContainer.Component("kvbinding", "bindings.postgresql", getStateStoreBindingProperties()))
