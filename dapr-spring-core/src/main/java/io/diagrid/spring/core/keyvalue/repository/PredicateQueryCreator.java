...
public class PredicateQueryCreator extends AbstractQueryCreator<KeyValueQuery<Predicate<?>>, Predicate<?>> {
  ...
  protected Predicate<?> create(Part part, Iterator<Object> iterator) {
    switch (part.getType()) {
      case TRUE:
        return io.diagrid.spring.core.keyvalue.repository.PredicateQueryCreator.PredicateBuilder.propertyValueOf(part)
            .isTrue();
      case FALSE:
        return io.diagrid.spring.core.keyvalue.repository.PredicateQueryCreator.PredicateBuilder.propertyValueOf(part)
            .isFalse();
      ...
      case BETWEEN:
        return io.diagrid.spring.core.keyvalue.repository.PredicateQueryCreator.PredicateBuilder.propertyValueOf(part)
            .isGreaterThan(iterator.next())
            .and(io.diagrid.spring.core.keyvalue.repository.PredicateQueryCreator.PredicateBuilder.propertyValueOf(part)
                .isLessThan(iterator.next()));
      case REGEX:
        return io.diagrid.spring.core.keyvalue.repository.PredicateQueryCreator.PredicateBuilder.propertyValueOf(part)
  ...
  static class PredicateBuilder {
    ...
    static io.diagrid.spring.core.keyvalue.repository.PredicateQueryCreator.PredicateBuilder propertyValueOf(
        Part part) {
    ...
    public Predicate<Object> isTrue() {
      return new io.diagrid.spring.core.keyvalue.repository.PredicateQueryCreator.ValueComparingPredicate(
